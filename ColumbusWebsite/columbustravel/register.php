...
if(isset($_POST['submit'])){
	...
	if(mysqli_query($conn, $sql)) 
	{
		...
		echo 'window.location.href="login.php";alert("Η εγγραφή σας πραγματοποιήθηκε με επιτυχία!");';
		echo '</script>';
	...
	{
		echo '<script language="javascript">';
		echo 'alert("Έγινε κάποιο λάθος!Η εγγραφή σας δεν πραγματοποιήθηκε!")';
		echo '</script>';
	}
	mysqli_close($conn);
}	
...
<h3 align="center"> Εγγραφή </h3>
<h5 style="padding-left:40px">Είστε ήδη μέλος;   <a href="login.php#in">    Είσοδος</a></h5><br>
<table class="form">
...
<tr>
 ...
 <td><input type="submit" name="submit" value="Εγγραφή" style="float:right"></td>
 </tr>
</table>
</fieldset>
</form> <br><br><br>
